  ...
  portfolios: {
    ...
    "hub": {
      ...
      bows:[
        ...
        {id:"bow1",name:"Advance Strategy Learning & Insight",color:"#F3E8FF",tagColor:"#9333EA",
    ...
    <div style={{flexShrink:0,width:(fluid||ind._fluid)?"100%":380,border:"1px solid "+BORDER,borderLeft:"3px solid "+sc.color,borderRadius:12,overflow:"hidden",boxShadow:"0 1px 4px rgba(10,37,64,0.04)",background:SURFACE}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",borderBottom:"1px solid "+BORDER}}>
        <div style={{padding:"12px 12px 10px",borderRight:"1px solid "+BORDER,textAlign:"center",background:SURFACE}}>
          <div style={{fontSize:12,fontWeight:600,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:0.6,marginBottom:4}}>{activeYear} Target</div>
        ...
        <div style={{padding:"12px 12px 10px",textAlign:"center",background:SURFACE}}>
          <div style={{fontSize:12,fontWeight:600,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:0.6,marginBottom:4}}>{activeYear} Actual</div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16}}>
        {[
          ...
          <div key={k.label} style={{background:SURFACE,borderRadius:12,border:"1px solid "+BORDER,padding:"18px 20px",boxShadow:"0 1px 4px rgba(10,37,64,0.05)"}}>
            <div style={{fontSize:12,fontWeight:700,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:1.5,marginBottom:8}}>{k.label}</div>
            <div style={{fontSize:32,fontWeight:700,color:k.color,lineHeight:1,marginBottom:6}}>{k.value}</div>
            <div style={{fontSize:13,color:TEXT_SUB}}>{k.sub}</div>
          </div>
        ))}
      </div>
          ...
          <div style={{flex:1,minWidth:0,background:SURFACE,borderRadius:12,border:"1px solid "+BORDER,overflow:"hidden",boxShadow:"0 1px 4px rgba(10,37,64,0.05)"}}>
            ...
            <div style={{padding:"20px 24px",borderBottom:"1px solid "+BORDER}}>
              ...
              {po.indicators.filter(ind=>ind.text).length > 0 ? (
                ...
                <div style={{fontSize:14,color:"#C9C3BA",fontStyle:"italic"}}>No indicators defined.</div>
              )}
            </div>
            ...
            <div>
              <button onClick={()=>setBowOpen(v=>!v)}
                ...
                <span style={{fontSize:12,color:TEXT_MUTED}}>{bowOpen?"▾":"▸"}</span>
                <span style={{fontSize:12,fontWeight:700,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:1}}>Contributing BOW Outcomes</span>
                <span style={{fontSize:12,background:"#EEEBE6",color:TEXT_SUB,borderRadius:10,padding:"1px 8px",fontWeight:700}}>{bowCount}</span>
                <span style={{marginLeft:"auto",fontSize:12,color:TEXT_MUTED,fontStyle:"italic",fontWeight:400}}>{bowOpen?"collapse":"expand"}</span>
              </button>
              {bowOpen&&(
                <div style={{padding:"4px 22px 18px",display:"flex",flexDirection:"column",gap:12}}>
                  {contributingBows.length===0
                    ? <div style={{fontSize:14,color:"#C9C3BA",fontStyle:"italic",paddingTop:10}}>No linked BOW outcomes.</div>
                    : contributingBows.map(b=>(
                        <div key={b.id} style={{borderRadius:10,border:"1px solid "+BORDER,borderLeft:"3px solid #C9C3BA",overflow:"hidden",background:SURFACE}}>
                          <div style={{padding:"8px 14px",background:"#EEEBE6",borderBottom:"1px solid "+BORDER}}>
                            <div style={{fontSize:12,fontWeight:700,color:TEXT_SUB,textTransform:"uppercase",letterSpacing:1.2}}>{b.name}</div>
                          </div>
                            ...
                            {b.outcomes.map((o,oi)=>{
                              ...
                              return (
                                <div key={o.id||oi} style={{display:"flex",alignItems:"flex-start",gap:10,padding:"10px 14px",borderBottom:isLast?"none":"1px solid "+BORDER}}>
                                  ...
                                  <div style={{flex:1,fontSize:13,color:TEXT,lineHeight:1.55}}>{o.title||o.shortTitle}</div>
                  ...
                  return (
                    <div key={g.number}>
                      <div style={{display:"flex",alignItems:"flex-start",gap:8,marginBottom:pct!==null?8:0}}>
                        ...
                        <div style={{flex:1}}>
                          <div style={{fontSize:13,fontWeight:700,color:TEXT,lineHeight:1.3,marginBottom:2}}>{g.title}</div>
                          <div style={{fontSize:12,color:TEXT_SUB,lineHeight:1.4}}>{g.target}</div>
                        </div>
                      </div>
                      {pct !== null && (
      ...
      {open&&(
        <div style={{borderTop:"1px solid "+BORDER}}>
          ...
          <div style={{padding:"18px 20px",borderBottom:"1px solid "+BORDER}}>
            ...
            <div>
              <div style={{fontSize:12,fontWeight:700,color:TEXT_SUB,textTransform:"uppercase",letterSpacing:0.6,marginBottom:5}}>Impact Narrative</div>
          ...
          <div style={{padding:"18px 20px",background:SURFACE_2}}>
            <div style={{fontSize:12,fontWeight:700,color:TEXT_SUB,textTransform:"uppercase",letterSpacing:0.8,marginBottom:10}}>{reportYear} Execution Targets</div>
            {targets.length===0 ? (
            ...
            <div>
              <div style={{fontSize:12,fontWeight:700,color:TEXT_SUB,textTransform:"uppercase",letterSpacing:0.6,marginBottom:5}}>Execution Narrative</div>
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:16}}>
      ...
      <div style={{background:SURFACE,borderRadius:12,border:"1px solid "+BORDER,padding:"18px 22px",display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:16}}>
        <div>
          <div style={{fontSize:12,fontWeight:600,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:2,marginBottom:4}}>Key Decisions</div>
      ...
      {decisions.map((d,i)=>{
        ...
        return (
          <div key={d.id} style={{background:SURFACE,borderRadius:12,border:"1px solid "+BORDER,overflow:"hidden",boxShadow:"0 1px 6px rgba(10,37,64,0.05)"}}>
            {/* Card header */}
            <div style={{padding:"16px 22px",borderBottom:"1px solid "+BORDER,display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:16}}>
              <div style={{flex:1}}>
              ...
              <div style={{flexShrink:0}}>
                <div style={{fontSize:12,fontWeight:700,color:TEXT_SUB,textTransform:"uppercase",letterSpacing:0.5,marginBottom:6,textAlign:"right"}}>Status</div>
            ...
            <div style={{padding:"18px 22px"}}>
              <div style={{fontSize:12,fontWeight:600,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:2,marginBottom:10}}>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:0}}>
      ...
      <div style={{background:SURFACE,borderBottom:"1px solid "+BORDER}}>
        ...
        <div style={{padding:"20px 28px 18px",display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:28}}>
          <div style={{flex:1}}>
            <div style={{fontSize:12,fontWeight:600,letterSpacing:2.5,textTransform:"uppercase",color:pc.color,marginBottom:8,opacity:0.9}}>Portfolio</div>
  ...
  return (
    <div style={{display:"flex",gap:0,background:SURFACE,borderRadius:14,border:"1px solid "+BORDER,boxShadow:"0 1px 8px rgba(0,0,0,0.05)",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",minWidth:0}}>
        ...
        <div>
          <div style={{fontSize:12,fontWeight:600,color:TEXT_MUTED,textTransform:"uppercase",letterSpacing:2,marginBottom:10}}>Contributing Portfolios</div>
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            {Object.entries(PORT_COLORS).map(([portId,pc])=>{
              const contributes = contributingPorts.includes(portId);
              return (
                <div key={portId} style={{display:"inline-flex",alignItems:"center",gap:8,padding:"8px 14px",background:contributes?SURFACE:BG,borderRadius:8,border:"1.5px solid "+(contributes?pc.color:BORDER),opacity:contributes?1:0.4,transition:"all .15s"}}>
...
// The four stages of the band, in order. Shared by the tablist and the tail row
    ...
    <div className="usp-toa">
      ...
      <section className="toa-hero">
        <div className="toa-banner">
          ...
          {/* A real tablist. These were divs with onClick, which gave no focus
              ring, no keyboard path and no announced state — and visually read
              as an infographic rather than a control. */}
          <div className="toa-row" role="tablist" aria-label="Theory of action stages">
            {TOA_STAGES.map((s, i) => (
              <button key={s.key} type="button" role="tab"
                id={"toa-tab-"+s.key}
                aria-selected={activeCol === s.key}
                aria-controls={"toa-panel-"+s.key}
          ...
          {/* Tail under the selected stage, pointing at its panel. Mirrors the
              chevron row's geometry so it lands under the right stage. */}
          <div className="toa-tails" aria-hidden="true">
            {TOA_STAGES.map(s => (
              <span key={s.key} className={"toa-tail"+(activeCol===s.key?" active":"")}/>
            ))}
          </div>
      ...
      {activeCol === "goals" && (
      <section className="toa-panel" role="tabpanel" id="toa-panel-goals" aria-labelledby="toa-tab-goals">
        <div className="toa-stage-head">
      ...
      {activeCol === "impact" && (
      <section className="toa-panel" role="tabpanel" id="toa-panel-impact" aria-labelledby="toa-tab-impact">
        <div className="toa-stage-head">
...
.usp-toa .toa-tail { flex:1; margin-left:-22px; position:relative; }
.usp-toa .toa-tail:first-child { margin-left:0; }
.usp-toa .toa-tail.active::after { content:""; position:absolute; left:calc(50% - 10px); top:0; width:0; height:0; border-left:10px solid transparent; border-right:10px solid transparent; border-top:10px solid ${ACCENT}; }
...
.usp-toa .toa-detail { margin-top:20px; }
/* Accent rule ties the panel back to the selected stage above */
.usp-toa .toa-panel { border-top:3px solid ${ACCENT}; padding-top:26px; animation:fadeIn .18s ease both; }
.usp-toa .toa-row { display:flex; align-items:stretch; }
.usp-toa .toa-chev, .usp-toa .toa-box { flex:1; padding:24px 26px 24px 40px; cursor:pointer; transition:transform .18s cubic-bezier(.4,0,.2,1), background .18s, opacity .15s; border:none; font-family:inherit; text-align:left; display:block; }
.usp-toa .toa-chev:focus-visible, .usp-toa .toa-box:focus-visible { outline:3px solid ${ACCENT}; outline-offset:-3px; }
...
function InvestmentIdeaTracker({ currentUser, appData }) {
  ...
  const titleOptions   = [...new Set(activeIdeas.map(i => i.title).filter(Boolean))].sort((a,b) => a.localeCompare(b));
  const partnerOptions = [...new Set(activeIdeas.map(i => i.potential_partner).filter(Boolean))].sort((a,b) => a.localeCompare(b));
  ...
  const toggleSort = (col, defaultDir = "desc") => {
    setSortConfig(prev => {
      if (prev.col !== col) return { col, dir: defaultDir };
      if (prev.dir === defaultDir) return { col, dir: defaultDir === "desc" ? "asc" : "desc" };
  ...
  // Apply sort to produce displayIdeas
  const displayIdeas = (() => {
    const sc = sortConfig;
            ...
            {!loading && !error && displayIdeas.length > 0 && (
              ...
              <table style={{ borderCollapse: "collapse", fontSize: 13, minWidth: 2200, tableLayout: "auto" }}>
                <thead>
                  ...
                  {(() => {
                    const fTh = (child) => (
                      <th style={{ padding: "4px 6px", borderBottom: "1px solid " + BORDER }}>{child}</th>
                    );
                    const fSel = (key, opts) => fTh(
                      <select value={colFilters[key]} onChange={e => setColFilter(key, e.target.value)}
                        style={{ width: "100%", padding: "3px 6px", borderRadius: 4, fontSize: 11,
                          border: colFilters[key] ? "1px solid #6366F1" : "1px solid " + BORDER,
                    ...
                    return (
                      <tr style={{ background: "#F1F5F9", position: "sticky", top: 29, zIndex: 2 }}>
                        ...
                        {/* Add'l BOWs */}
                        {fTh(<input value={colFilters.additional_bows} onChange={e => setColFilter("additional_bows", e.target.value)}
                    ...
                    return (
                      <tr key={idea.id}
                        ...
                        <td style={{ padding: "9px 14px", color: TEXT_SUB, whiteSpace: "nowrap", minWidth: 100 }}>
                          {fmtDate(idea.desired_start_date)}
                        </td>
                        <td style={{ padding: "9px 14px", color: TEXT_SUB, whiteSpace: "nowrap", minWidth: 100 }}>
                          {idea.est_duration || "—"}
                        </td>
...
const DM_TABLE_POS = {
  ...
  // Col 2 — Indicators & Sources (x=240)
  ...
  strategy_goal_actuals:       {x:240,  y:194}, sources:                     {x:240,  y:232},
  source_rounds:               {x:240,  y:270},
  // Col 3 — Execution / Ratings / TOA (x=460)
  ...
  portfolio_toa:               {x:460,  y:316}, portfolio_toa_lanes:         {x:460,  y:354},
  portfolio_toa_activities:    {x:460,  y:392}, portfolio_toa_lane_indicators:{x:460, y:430},
  // Col 4 — Assumptions / Decisions (x=680)
  ...
  key_decisions:               {x:680,  y:388}, decision_assumption_links:   {x:680,  y:426},
  // Col 5 — Investments (x=900)
  ...
  budget_forecast_snapshots:   {x:900,  y:194}, investment_ideas:            {x:900,  y:232},
  investment_idea_comments:    {x:900,  y:270},
  // Col 6 — Notes, Tracking & Activity (x=1120)
  bow_notes:                   {x:1120, y:42},  portfolio_tracking:          {x:1120, y:80},
  partner_tracking:            {x:1120, y:118}, team_members:                {x:1120, y:156},
  pending_actuals:             {x:1120, y:194}, content_edit_log:            {x:1120, y:232},
  comments:                    {x:1120, y:270}, feedback:                    {x:1120, y:308},
};
const DM_GROUP_RECTS = [
  {id:"structure",   x:10,   y:4,   w:200, h:308, label:"Strategy Structure"},
  {id:"indicators",  x:230,  y:4,   w:200, h:308, label:"Indicators & Actuals"},
  {id:"execution",   x:450,  y:4,   w:200, h:116, label:"Execution"},
  {id:"ratings",     x:450,  y:130, w:200, h:148, label:"Ratings"},
  {id:"toa",         x:450,  y:290, w:200, h:192, label:"Theory of Action"},
  {id:"assumptions", x:670,  y:4,   w:200, h:346, label:"Assumptions"},
  {id:"decisions",   x:670,  y:370, w:200, h:108, label:"Key Decisions"},
  {id:"investments", x:890,  y:4,   w:200, h:308, label:"Investments"},
  {id:"tracking",    x:1110, y:4,   w:200, h:346, label:"Notes & Tracking"},
];
...
const DM_GROUPS = [
  ...
  {id:"toa",         label:"Theory of Action",          color:"#0D9488", tables:["portfolio_toa","portfolio_toa_lanes","portfolio_toa_activities","portfolio_toa_lane_indicators"]},
  {id:"indicators",  label:"Indicators & Actuals",      color:"#059669", tables:["sources","source_rounds","bow_indicators","bow_indicator_actuals","portfolio_indicators","portfolio_indicator_actuals","strategy_goal_actuals"]},
  ...
  {id:"investments", label:"Investments (INVEST/EDP)",  color:"#64748B", tables:["invest_investments","invest_bow_allocation","invest_bow_details","investment_overlays","investment_ideas","investment_idea_comments","budget_forecast_snapshots"]},
...
const DM_TABLES = {
  ...
  source_rounds:{cols:[{n:"round_id",t:"string",pk:true},{n:"source_id",t:"string",fk:"sources"},{n:"round_label",t:"string"},{n:"collection_date",t:"date"},{n:"document_url",t:"string"},{n:"notes",t:"string"},{n:"created_at",t:"timestamp"},{n:"created_by",t:"string"}],refs:["sources"]},
  bow_indicators:{cols:[{n:"indicator_id",t:"string",pk:true},{n:"bow_id",t:"string",fk:"bows"},{n:"outcome_id",t:"string",fk:"bow_outcomes"},{n:"name",t:"string"},{n:"text",t:"string"},{n:"purpose",t:"string"},{n:"data_source",t:"string"},{n:"source_id",t:"string",fk:"sources"},{n:"measurement_level",t:"string"},{n:"baseline",t:"double"},{n:"target_2026",t:"string"},{n:"target_2027",t:"string"},{n:"target_2028",t:"string"},{n:"target_2029",t:"string"},{n:"target_2030",t:"string"},{n:"unit",t:"string"},{n:"collection_frequency",t:"string",note:"annual | biannually | quarterly | bimonthly | monthly"},{n:"thematic_tags",t:"string"},{n:"status",t:"string"},{n:"data_quality_notes",t:"string"},{n:"tracking_notes",t:"string"},{n:"indicator_owner",t:"string"},{n:"last_reviewed_date",t:"date"},{n:"is_active",t:"boolean",note:"default true"}],refs:["bows","bow_outcomes","sources"]},
  bow_indicator_actuals:{cols:[{n:"actual_id",t:"string",pk:true},{n:"indicator_id",t:"string",fk:"bow_indicators"},{n:"bow_id",t:"string",fk:"bows"},{n:"outcome_id",t:"string",fk:"bow_outcomes"},{n:"year",t:"int"},{n:"period",t:"string",note:"Q1–Q4 | M01–M12 — null for annual"},{n:"actual_value",t:"double"},{n:"reading_date",t:"date"},{n:"source_notes",t:"string"},{n:"loaded_by",t:"string"},{n:"loaded_at",t:"timestamp"}],refs:["bow_indicators","bows","bow_outcomes"]},
  portfolio_indicators:{cols:[{n:"indicator_id",t:"string",pk:true},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"outcome_id",t:"string",fk:"portfolio_outcomes"},{n:"name",t:"string"},{n:"text",t:"string"},{n:"purpose",t:"string"},{n:"data_source",t:"string"},{n:"source_id",t:"string",fk:"sources"},{n:"measurement_level",t:"string"},{n:"baseline",t:"double"},{n:"target_2026",t:"string"},{n:"target_2027",t:"string"},{n:"target_2028",t:"string"},{n:"target_2029",t:"string"},{n:"target_2030",t:"string"},{n:"unit",t:"string"},{n:"collection_frequency",t:"string",note:"annual | biannually | quarterly | bimonthly | monthly"},{n:"thematic_tags",t:"string"},{n:"status",t:"string"},{n:"data_quality_notes",t:"string"},{n:"tracking_notes",t:"string"},{n:"indicator_owner",t:"string"},{n:"last_reviewed_date",t:"date"},{n:"is_active",t:"boolean"}],refs:["portfolios","portfolio_outcomes","sources"]},
  portfolio_indicator_actuals:{cols:[{n:"actual_id",t:"string",pk:true},{n:"indicator_id",t:"string",fk:"portfolio_indicators"},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"outcome_id",t:"string",fk:"portfolio_outcomes"},{n:"year",t:"int"},{n:"period",t:"string",note:"Q1–Q4 | M01–M12 — null for annual"},{n:"actual_value",t:"double"},{n:"reading_date",t:"date"},{n:"source_notes",t:"string"},{n:"loaded_by",t:"string"},{n:"loaded_at",t:"timestamp"}],refs:["portfolio_indicators","portfolios","portfolio_outcomes"]},
  strategy_goal_actuals:{cols:[{n:"actual_id",t:"string",pk:true},{n:"goal_id",t:"string",fk:"strategy_goals"},{n:"year",t:"int"},{n:"actual_value",t:"double"},{n:"reading_date",t:"date"},{n:"source_notes",t:"string"},{n:"loaded_by",t:"string"},{n:"loaded_at",t:"timestamp"}],refs:["strategy_goals"]},
  execution_targets:{cols:[{n:"target_id",t:"string",pk:true},{n:"bow_id",t:"string",fk:"bows"},{n:"outcome_id",t:"string",fk:"bow_outcomes"},{n:"year",t:"int"},{n:"text",t:"string"},{n:"completion",t:"string"},{n:"notes",t:"string"},{n:"sort_order",t:"int"},{n:"is_active",t:"boolean",note:"default true"},{n:"last_updated",t:"timestamp"},{n:"updated_by",t:"string"}],refs:["bows","bow_outcomes"]},
  ...
  portfolio_toa:{cols:[{n:"portfolio_id",t:"string",pk:true,fk:"portfolios"},{n:"col1_label",t:"string"},{n:"col2_label",t:"string"},{n:"problem_statement",t:"string"},{n:"cross_indicators_json",t:"string",note:"JSON"},{n:"cross_indicators_label",t:"string"},{n:"amb45_intro_text",t:"string"},{n:"amb45_label",t:"string"},{n:"amb45_full_text",t:"string"},{n:"amb45_buckets_json",t:"string",note:"JSON"},{n:"is_active",t:"boolean"}],refs:["portfolios"]},
  portfolio_toa_lanes:{cols:[{n:"lane_id",t:"string",pk:true},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"label",t:"string"},{n:"icon",t:"string"},{n:"color",t:"string"},{n:"outcome_text",t:"string"},{n:"is_tbd",t:"boolean"},{n:"is_multiplier",t:"boolean"},{n:"sort_order",t:"int"},{n:"is_active",t:"boolean"}],refs:["portfolios"]},
  portfolio_toa_activities:{cols:[{n:"activity_id",t:"string",pk:true},{n:"lane_id",t:"string",fk:"portfolio_toa_lanes"},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"activity_text",t:"string"},{n:"sort_order",t:"int"}],refs:["portfolio_toa_lanes","portfolios"]},
  portfolio_toa_lane_indicators:{cols:[{n:"indicator_id",t:"string",pk:true},{n:"lane_id",t:"string",fk:"portfolio_toa_lanes"},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"indicator_text",t:"string"},{n:"sort_order",t:"int"}],refs:["portfolio_toa_lanes","portfolios"]},
  ...
  portfolio_outcome_ratings:{cols:[{n:"rating_id",t:"string",pk:true},{n:"outcome_id",t:"string",fk:"portfolio_outcomes"},{n:"year",t:"int"},{n:"rating",t:"string"},{n:"rationale",t:"string"},{n:"human_override",t:"boolean"},{n:"override_reasoning",t:"string"},{n:"assessed_by",t:"string"},{n:"assessed_at",t:"timestamp"}],refs:["portfolio_outcomes"]},
  goal_ratings:{cols:[{n:"rating_id",t:"string",pk:true},{n:"goal_id",t:"string",fk:"strategy_goals"},{n:"year",t:"int"},{n:"rating",t:"string"},{n:"rationale",t:"string"},{n:"human_override",t:"boolean"},{n:"override_reasoning",t:"string"},{n:"assessed_by",t:"string"},{n:"assessed_at",t:"timestamp"}],refs:["strategy_goals"]},
  ...
  assumption_rating_criteria:{cols:[{n:"criteria_id",t:"string",pk:true},{n:"assumption_type",t:"string",note:"field | impact"},{n:"bow_id",t:"string",fk:"bows",note:"nullable — BOW-level"},{n:"high_threshold",t:"string"},{n:"medium_threshold",t:"string"},{n:"low_threshold",t:"string"},{n:"data_gap_trigger",t:"string"},{n:"signal_weights",t:"string",note:"JSON"},{n:"version",t:"int",note:"default 1"},{n:"last_updated",t:"timestamp"},{n:"updated_by",t:"string"}],refs:["bows"]},
  ...
  key_decisions:{cols:[{n:"decision_id",t:"string",pk:true},{n:"level",t:"string",note:"strategy | portfolio | bow"},{n:"bow_id",t:"string",fk:"bows"},{n:"portfolio_id",t:"string",fk:"portfolios",note:"nullable — portfolio-level"},{n:"goal_id",t:"string",fk:"strategy_goals",note:"nullable — strategy-level"},{n:"question",t:"string"},{n:"decision_text",t:"string"},{n:"timing",t:"string"},{n:"signals",t:"string"},{n:"decision_priority",t:"string",note:"H | M | L"},{n:"decision_maker",t:"string"},{n:"resolution_type",t:"string",note:"invest | scale | adapt | stop"},{n:"decision_rationale",t:"string"},{n:"recorded_outcome",t:"string"},{n:"status",t:"string"},{n:"is_active",t:"boolean"},{n:"last_updated",t:"timestamp"},{n:"updated_by",t:"string"}],refs:["bows","portfolios","strategy_goals"]},
  decision_assumption_links:{cols:[{n:"link_id",t:"string",pk:true},{n:"decision_id",t:"string",fk:"key_decisions"},{n:"assumption_id",t:"string",fk:"assumptions"},{n:"signal_role",t:"string",note:"primary | secondary"},{n:"trigger_threshold",t:"string"},{n:"rationale",t:"string"}],refs:["key_decisions","assumptions"]},
  ...
  portfolio_tracking:{cols:[{n:"tracking_id",t:"string",pk:true},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"year",t:"int"},{n:"notes",t:"string"},{n:"team_members",t:"string"},{n:"budget_annotation",t:"string"},{n:"last_updated",t:"timestamp"},{n:"updated_by",t:"string"}],refs:["portfolios"]},
  partner_tracking:{cols:[{n:"tracking_id",t:"string",pk:true},{n:"partner_id",t:"string"},{n:"portfolio_id",t:"string",fk:"portfolios"},{n:"notes",t:"string"},{n:"relationship_status",t:"string"},{n:"last_updated",t:"timestamp"},{n:"updated_by",t:"string"}],refs:["portfolios"]},
  ...
  pending_actuals:{cols:[{n:"pending_id",t:"string",pk:true},{n:"indicator_id",t:"string",note:"logical FK — bow_indicators or portfolio_indicators"},{n:"level",t:"string",note:"bow | portfolio | goal"},{n:"entity_id",t:"string"},{n:"year",t:"int"},{n:"period",t:"string",note:"Q1–Q4 | M01–M12 — null for annual"},{n:"submitted_value",t:"double"},{n:"reading_date",t:"string"},{n:"source_notes",t:"string"},{n:"submitted_by",t:"string"},{n:"submitted_role",t:"string"},{n:"submitted_permission",t:"string",note:"MLE | Leadership | Team"},{n:"submitted_at",t:"timestamp"},{n:"status",t:"string",note:"pending | approved | rejected"},{n:"reviewed_value",t:"double"},{n:"reviewed_by",t:"string"},{n:"reviewer_notes",t:"string"},{n:"reviewed_at",t:"timestamp"},{n:"notes",t:"string"}],refs:[]},
  content_edit_log:{cols:[{n:"log_id",t:"string",pk:true},{n:"entity_type",t:"string"},{n:"entity_id",t:"string"},{n:"bow_id",t:"string",fk:"bows",note:"nullable"},{n:"portfolio_id",t:"string",fk:"portfolios",note:"nullable"},{n:"changes",t:"string",note:"JSON — field-level diff"},{n:"rationale",t:"string"},{n:"revision_reason",t:"string"},{n:"edited_by",t:"string"},{n:"edited_at",t:"timestamp"}],refs:["bows","portfolios"]},
  comments:{cols:[{n:"comment_id",t:"string",pk:true},{n:"entity_type",t:"string"},{n:"entity_id",t:"string"},{n:"author",t:"string"},{n:"author_email",t:"string"},{n:"body",t:"string"},{n:"created_at",t:"timestamp"}],refs:[]},
  feedback:{cols:[{n:"feedback_id",t:"string",pk:true},{n:"submitted_by",t:"string"},{n:"author_name",t:"string"},{n:"submitted_at",t:"timestamp"},{n:"source",t:"string"},{n:"rating",t:"int"},{n:"working_well",t:"string"},{n:"improve",t:"string"}],refs:[]},
};
...
function BudgetForecastsView() {
  return (
    <div style={{maxWidth:720,margin:"64px auto",padding:"0 32px",display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center",gap:20}}>
      <div style={{width:56,height:56,borderRadius:"50%",background:SURFACE,border:"1px solid "+BORDER,display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,marginBottom:4}}>📊</div>
      <div style={{fontSize:22,fontWeight:800,color:TEXT,letterSpacing:-0.4}}>Budget Forecast Snapshots</div>
      <div style={{fontSize:15,color:TEXT_SUB,lineHeight:1.8,maxWidth:560}}>
        Future budget forecast snapshots will live here. These analyses are conducted outside of this dashboard environment — once new forecasts are verified, the data will be shared here for reference and review.
      </div>
      <div style={{fontSize:13,color:TEXT_MUTED,background:SURFACE,border:"1px solid "+BORDER,borderRadius:10,padding:"14px 20px",maxWidth:480,lineHeight:1.7}}>
        Forecasts are validated and approved before being published here. Check back as new planning cycles are completed.
      </div>
    </div>
  );
}
